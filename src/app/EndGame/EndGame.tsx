...
export const EndGame = () => {
    const { score, totalQuestions, dificulty, restart } = useGameContext();
        ...
        <section className="p-4">
            <div className="bg-zinc-900 rounded-3xl p-12 shadow-2xl border-2 border-zinc-700 max-w-2xl w-full">
                <div className="text-center mb-8">
                    <p className="text-gray-400 text-lg capitalize">Dificultad: {dificulty}</p>
                </div>
                ...
                <div className="bg-zinc-800 rounded-2xl p-8 mb-8 border-2 border-zinc-700">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-center">
                        ...
                        <div className="bg-zinc-900 rounded-xl p-4 border border-zinc-600">
                            <p className="text-gray-400 text-sm mb-1">Incorrectas</p>
                            <p className="text-red-400 text-3xl font-bold">{totalQuestions - score}</p>
                        </div>
                    </div>
                </div>
